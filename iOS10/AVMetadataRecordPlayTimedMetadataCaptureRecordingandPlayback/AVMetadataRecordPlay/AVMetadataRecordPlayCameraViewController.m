...
- (void)viewDidLoad
{
	...
	dispatch_async( self.sessionQueue, ^{
		...
		AVCaptureDevice *videoDevice = [AVMetadataRecordPlayCameraViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:AVCaptureDevicePositionBack];
		...
		if ( [self.session canAddInput:videoDeviceInput] ) {
			...
			dispatch_async( dispatch_get_main_queue(), ^{
				...
				// Because AVCaptureVideoPreviewLayer is the backing layer for AVMetadataRecordPlayCameraPreviewView and UIView
...
- (IBAction)toggleMovieRecording:(id)sender
{
	...
	dispatch_async( self.sessionQueue, ^{
		if ( ! self.movieFileOutput.isRecording ) {
			...
			[AVMetadataRecordPlayCameraViewController setFlashMode:AVCaptureFlashModeOff forDevice:self.videoDeviceInput.device];
...
- (IBAction)changeCamera:(id)sender
{
	...
	dispatch_async( self.sessionQueue, ^{
		...
		AVCaptureDevice *videoDevice = [AVMetadataRecordPlayCameraViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:preferredPosition];
		...
		if ( [self.session canAddInput:videoDeviceInput] ) {
			...
			[AVMetadataRecordPlayCameraViewController setFlashMode:AVCaptureFlashModeAuto forDevice:videoDevice];
